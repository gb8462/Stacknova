...
label = Label(window, textvariable=equation_label, font=('Times New Roman', 20),
...
times = Button(frame, text='*', height=4, width=9, font=35,
                command= lambda: button_press('*'))
...
"""A fun calculator UI to learn and use"""from tkinter import *
